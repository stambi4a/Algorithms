namespace Sortable_Collection.Tests
{
    ...
    public class InterpolationSearchTests
    {
        ...
        public void TestWithEmptyCollectionShouldReturnMissingElement()
        {
            ...
            var result = collection.InterpolationSearch(collection.Items, 0);
        ...
        public void TestWithItemAtMidpoint()
        {
            ...
            var result = collection.InterpolationSearch(collection.Items, 3);
        ...
        public void TestWithItemToTheLeftOfMidpoint()
        {
            ...
            var result = collection.InterpolationSearch(collection.Items, 2);
        ...
        public void TestWithItemToTheRightOfMidpoint()
        {
            ...
            var result = collection.InterpolationSearch(collection.Items, 4);
        ...
        public void TestWithMultipleMissingKeysSmallerThanMinimum()
        {
            ...
            for (int i = 0; i < NumberOfChecks; i++)
            {
                ...
                int result = collection.InterpolationSearch(collection.Items, item);
        ...
        public void TestWithMultipleMissingKeysLargerThanMaximum()
        {
            ...
            for (int i = 0; i < NumberOfChecks; i++)
            {
                var item = Random.Next(collection.Items[elements.Length - 1], int.MaxValue);
        ...
        public void TestWithMultipleKeys()
        {
            ...
            foreach (var element in elements)
            {
                ...
                int result = collection.InterpolationSearch(collection.Items, element);
